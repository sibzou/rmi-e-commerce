...
java -cp bin --module-path deps/javafx-linux/lib --add-modules javafx.controls com.rmiecommerce.client.Client
...
javac -d bin -cp src/main/java --module-path deps/javafx-linux/lib --add-modules javafx.controls src/main/java/com/rmiecommerce/client/Client.java
